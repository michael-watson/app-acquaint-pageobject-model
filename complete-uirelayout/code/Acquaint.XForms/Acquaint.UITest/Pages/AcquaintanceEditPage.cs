...
namespace Acquaint.UITest.Pages
{
	public class AcquaintanceEditPage : BasePage
	{
		...
		public Query FirstNameEntry, LastNameEntry, CompanyEntry, TitleEntry, PhoneEntry, EmailEntry, StreetEntry, CityEntry, StateEntry, ZipEntry, InvalidEntryDialog;
		...
		public AcquaintanceEditPage(IApp app, Platform platform) : base(app, platform)
		{
			...
			{
				SaveButton = x => x.Class("UINavigationButton").Index(0);
		...
		public void WaitForPageNavigationToComplete()
		{
			...
			app.Screenshot("On page to enter acquaintance information");
		}
		/// <summary>
		/// Gets the first name.
		/// </summary>
		...
		public void ScrollDownToEntry(Query entryToScrollDownTo)
		{
			app.ScrollDownTo(entryToScrollDownTo);
